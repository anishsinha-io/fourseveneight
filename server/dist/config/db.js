...
var connectDatabase = function () { return __awaiter(void 0, void 0, void 0, function () {
    var currentDate, database, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                currentDate = new Date();
                database = process.env.DATABASE_URI.replace(/<password>/gi, process.env.DATABASE_PASSWORD);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, mongoose_1.default.connect(database)];
            case 2:
                _a.sent();

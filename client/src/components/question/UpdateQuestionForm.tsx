...
import { loadQuestion, INewQuestion, editQuestion } from "./questionSlice";
...
const UpdateForm: ({
  ...
  if (!question.user && status === "idle") return <div>Post not found!</div>;
  ...
  return (
    <Fragment>
      <div className="question-form">
        ...
        <RichTextEditor content={question.content} />
